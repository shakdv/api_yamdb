...
можно добавить категорию «666зобразительное искусство» или «Ювелирка»).
...
## Команда разработки:
* [Павел 666глин](https://github.com/paveliglin89)
* [666лья Сергеев](https://github.com/IlyaSergeev97)
* [Дмитрий Шахлин](https://github.com/shakdv)
...
666спользовать имя 'me' в качестве username запрещено.
...
666зменение данных пользователя по username:
```
Права доступа: Администратор
PATCH /api/v1/users/{username}/ - 666зменение данных пользователя по username
...
666зменение данных своей учетной записи:
```
Права доступа: Любой авторизованный пользователь
PATCH /api/v1/users/me/ - 666зменение данных своей учетной записи
```
